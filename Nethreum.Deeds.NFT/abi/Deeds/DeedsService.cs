...
using Nethereum_Deeds_NFT.Contracts.Deeds.ContractDefinition;

namespace Nethereum_Deeds_NFT.Contracts.Deeds
{
    public partial class DeedsService
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, DeedsDeployment deedsDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            return web3.Eth.GetContractDeploymentHandler<DeedsDeployment>().SendRequestAndWaitForReceiptAsync(deedsDeployment, cancellationTokenSource);
        }

        public static Task<string> DeployContractAsync(Nethereum.Web3.Web3 web3, DeedsDeployment deedsDeployment)
        {
            return web3.Eth.GetContractDeploymentHandler<DeedsDeployment>().SendRequestAsync(deedsDeployment);
        }

        public static async Task<DeedsService> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, DeedsDeployment deedsDeployment, CancellationTokenSource cancellationTokenSource = null)
        {
            var receipt = await DeployContractAndWaitForReceiptAsync(web3, deedsDeployment, cancellationTokenSource);
            return new DeedsService(web3, receipt.ContractAddress);
        }
        ...
        public DeedsService(Nethereum.Web3.Web3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }

        public DeedsService(Nethereum.Web3.IWeb3 web3, string contractAddress)
        {
            Web3 = web3;
            ContractHandler = web3.Eth.GetContractHandler(contractAddress);
        }
        ...
        public Task<string> AwardTokenRequestAsync(AwardTokenFunction awardTokenFunction)
        {
             return ContractHandler.SendRequestAsync(awardTokenFunction);
        }

        public Task<TransactionReceipt> AwardTokenRequestAndWaitForReceiptAsync(AwardTokenFunction awardTokenFunction, CancellationTokenSource cancellationToken = null)
        {
             return ContractHandler.SendRequestAndWaitForReceiptAsync(awardTokenFunction, cancellationToken);
        }

        public Task<string> AwardTokenRequestAsync(string to)
        {
            var awardTokenFunction = new AwardTokenFunction();
                awardTokenFunction.To = to;
            
             return ContractHandler.SendRequestAsync(awardTokenFunction);
        }

        public Task<TransactionReceipt> AwardTokenRequestAndWaitForReceiptAsync(string to, CancellationTokenSource cancellationToken = null)
        {
            var awardTokenFunction = new AwardTokenFunction();
                awardTokenFunction.To = to;
